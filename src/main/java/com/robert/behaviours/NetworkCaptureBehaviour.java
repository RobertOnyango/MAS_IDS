...
public class NetworkCaptureBehaviour extends Behaviour{
	...
	public NetworkCaptureBehaviour(final Agent myAgent) {
		super(myAgent);
	...
	public void action() {
		...
		//final MessageTemplate msgTemplate = MessageTemplate.MatchPerformative(ACLMessage.INFORM);
  		final ACLMessage msg = this.myAgent.receive();
  		/**
  		System.out.println("Analysis Agent - The message is:" +msg);
  		System.out.println();
		*/
  		 if(msg != null) {
		...
		try {
            ...
            System.out.println("The total number of packets in the file is:" + count);
            System.out.println("The total number of icmp packets in the file is:" + count_icmp);
            System.out.println("The total number of tcp packets in the file is:" + count_tcp);
            System.out.println("The total number of ip packets in the file is:" + count_ip);
            System.out.println("The total number of udp packets in the file is:" + count_udp);
            //Close the pcap
            pcap.close();
		} 
